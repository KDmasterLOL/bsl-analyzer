...
|---------|---------------------------|----------------------|---------|
| **Wall time** | 132.6s | 76s | 1.7x быстрее |
| **Peak RSS** | 4 566 MB | 1 520 MB | 3.0x меньше памяти |
| **Files/sec** | 94 | 178 | 1.9x пропускная способность |
| **Диагностик** | 552 111 | 610 477 | — |

**О разнице в количестве диагностик.** bsl-analyzer нашёл на 11% больше срабатываний. Это объясняется несколькими факторами:
