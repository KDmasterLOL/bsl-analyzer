# selective-diagnostics-baseline-partitions Specification

## Purpose
TBD - created by archiving change add-selective-diagnostics-baseline-partitions. Update Purpose after archive.
## Requirements
