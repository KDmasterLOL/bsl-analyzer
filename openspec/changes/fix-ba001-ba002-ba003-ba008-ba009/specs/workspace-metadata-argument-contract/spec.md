...
- **THEN** инструмент передаёт исходный `object_type` живому сервису без автоматической замены или повторного запроса и возвращает существующую ошибку сервиса
