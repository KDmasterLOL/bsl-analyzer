...
- `crates/parser/tests/sdbl_recovery_and_allowances.rs` — 45 acceptance
  tests;
- `crates/parser/tests/sdbl_parser_invariants.rs` — the same invariants as
...
Twelve review rounds were run, each because the one before it had found
...
depends on that — it runs while input remains, skips separators wherever
...
C10 `b23695ff`, C11 `0bcbdf4a`, C12 `09ceb39e`, C13 `9cf16871`, C14 `2e358746`, C15 `f0dbf5c3`, C16 `ecb73b45`, C17 `420878d5`, C18 `b4241dd7`, C19 the audit re-run's fixes. Two earlier commits landed
