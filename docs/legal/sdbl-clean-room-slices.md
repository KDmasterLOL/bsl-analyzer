...
- `crates/parser/tests/sdbl_recovery_and_allowances.rs` — 42 acceptance
  tests;
...
Ten review rounds were run, each because the one before it had found
...
C10 `b23695ff`, C11 `0bcbdf4a`, C12 `09ceb39e`, C13 the tenth round's fixes. Two earlier commits landed
