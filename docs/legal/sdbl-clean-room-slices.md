...
- `crates/parser/tests/sdbl_recovery_and_allowances.rs` — 38 acceptance
  tests;
...
Seven review rounds were run, each because the one before it had found
...
C10 the seventh round's fixes. Two earlier commits landed
