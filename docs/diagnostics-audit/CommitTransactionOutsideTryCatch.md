...
- Локальный `v8std`:
  `/home/itrous/src/tools_migration/lsp/v8std/docs/diagnostics/bslls/CommitTransactionOutsideTryCatch.md`,
  `/home/itrous/src/tools_migration/lsp/v8std/docs/diagnostics/v8-code-style/commit-transaction.md`,
