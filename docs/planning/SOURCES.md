...
### Метаданные
1. **bsl-language-server** - mdclasses интеграция
2. **bsl-language-server-rust/bsl-metadata/** - Rust структуры
