...
- **`root_id` — часть тождества находки, а не украшение.** Расширение повторяет структуру
  ...
  расширения, объявленного ВНУТРИ её корня: такое расширение своего корня не заводит, и его
  файлы остаются файлами конфигурации. У расширения под каталогом проекта идентификатор —
