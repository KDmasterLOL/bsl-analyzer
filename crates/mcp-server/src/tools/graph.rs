...
mod tests {
    ...
    fn schema_advertises_the_current_contract_shape() {
        ...
        assert_eq!(schema["schema_version"], "31");
    ...
    fn schema_and_loading_populate_structured_content() {
        ...
        assert_eq!(schema().structured_content.unwrap()["schema_version"], "31");
