...
mod tests {
    ...
    fn schema_advertises_the_current_contract_shape() {
        ...
        // and the `register_movement` edge (Движения.<Регистр>) since version 19.
        assert_eq!(schema["schema_version"], "19");
        assert!(
    ...
    fn schema_and_loading_populate_structured_content() {
        ...
        assert_eq!(schema().structured_content.unwrap()["schema_version"], "19");
